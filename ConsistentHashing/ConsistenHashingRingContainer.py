...
if __name__ == "__main__":
    ring = ConsistentHashingRingContainer(cache_size=3, servers=["server1", "server2"], replication_factor=2)
    ...
    print(ring.get_cache_entry("key2"))  # Should print value21
    print(ring.get_cache_entry("key1"))  # Should print value21
